...
export const content = {
    ...
    "about": {
        ...
        "imgSrc": "./infoposts/Andrew-digital-nomad-portrait.jpeg",
        "post": `
    <p>Hi, I’m Andrew. My hair color changes every few months. My headphones have cat ears and I won’t take them off. 
    ...
    out Case Studies on my website, <a href="https://www.Andrewwilkinson.com">Andrewwilkinson.com</a>. I look forward to your 
    ...
    <p>Much love and light, Andrew</p>
    `
    }
}