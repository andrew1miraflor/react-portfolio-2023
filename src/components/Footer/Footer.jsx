        ...
        <motion.section
            ...
            <motion.div
                ...
                <div className={css.left}>
                    ...
                    <span className="primaryText">
                        {/* Start by <a href="https://www.linkedin.com/in/Andrewwilkinson/" target="_blank">saying hi</a> */}
                    </span>
                </div>
                ...
                <div className={css.right}>
                    ...
                    {/* <li><HashLink smooth to="https://www.linkedin.com/in/Andrewwilkinson/" target="_blank">LinkedIn 
                    <img style={{'height':'1rem'}} src={linkedin} /></HashLink></li>
                    <li><HashLink smooth to="https://github.com/Andrewwilkinson" target="_blank">GitHub <img style={{'height':'1rem'}} src={github} /></HashLink></li> */}
                </ul>
                </div>
            </motion.div>
        </motion.section>
